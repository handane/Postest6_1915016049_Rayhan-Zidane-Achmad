...
import 'package:postest6_1915016049_rayhanzidaneachmad/splashscreen.dart';
import 'package:postest6_1915016049_rayhanzidaneachmad/custom_alert.dart';
import 'package:postest6_1915016049_rayhanzidaneachmad/controller.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        flexibleSpace: Obx(() => Container(
              color: swc.switchValue.value ? Colors.green : Colors.orange,
            )),
